# -*- coding: utf-8 -*-
#
# PPPACK documentation build configuration file, created by
# sphinx-quickstart on Tue May  2 17:15:50 2017.
#
...
# include docstring of __init__ and __call__ methods
...
sys.path.insert(0, os.path.abspath('../pppack'))

# fix doc build with virtualenv on RTD
...
project = u'PPPACK'
copyright = u'2017, Daniele Tomatis'
author = u'Daniele Tomatis'
...
try:
    from pppack import __version__ as moduleversion
    version = moduleversion
except:
    version = u'1.1.0'
# The full version, including alpha/beta/rc tags.
# check the following to agree with the value in ../setup.py
#release = u'1.1.0'
...
latex_documents = [
    (master_doc, 'PPPACK.tex', u'PPPACK Documentation',
...
man_pages = [
    (master_doc, 'pppack', u'PPPACK Documentation',
     [author], 1)
]
