...
!f2py intent(in) nrow
!f2py intent(in) nroww
!f2py intent(in) nbandl
!f2py intent(in) nbandu
...
!
  ...
  real ( kind = 8 ) t(n+k)
!f2py intent(in) t
!f2py intent(in) bcoef
!f2py intent(in) n
!f2py intent(in) k
!f2py intent(out) scrtch
!f2py intent(out) break
...
!
  ...
  real ( kind = 8 ) x
!f2py intent(in) t
!f2py intent(in) jhigh
!f2py intent(in) index
!f2py intent(in) x
!f2py intent(in) left
!f2py intent(out) biatx
...
!f2py intent(in) x
!f2py intent(in) left
!f2py intent(in) nderiv
!f2py intent(out) a
!f2py intent(out) dbiatx
...
!f2py intent(in) k
!f2py intent(in) x
!f2py intent(in) jderiv
!f2py intent(out) bvalue
...
!
  ...
  real ( kind = 8 ) xside
!f2py intent(in) aleft
!f2py intent(in) aright
!f2py intent(in) lbegin
!f2py intent(in) iorder
!f2py intent(in) ntimes
!f2py intent(in) addbrk
!f2py intent(in) relerr
...
!f2py intent(in) n
!f2py intent(inout) c
!f2py intent(in) ibcbeg
!f2py intent(in) ibcend
!
...
!
  ...
  real ( kind = 8 ) x(nequ)
!f2py intent(inout) neq
!f2py intent(inout) ncols
!f2py intent(inout) integs
!f2py intent(inout) nbloks
!f2py intent(inout) b
!f2py intent(inout) w
!f2py intent(out) d
!f2py intent(out) iflag
...
!f2py intent(out) v
  ...
  common / approx / l, kpm, break(npiece), coef(ncoef)
  common / other / itermx, k, rho(19)
  common / side / m, iside, xside(10)
!
...
!
  ...
  integer ( kind = 4 ) last
  integer ( kind = 4 ) nrow
!f2py depend(nbloks) integs
!f2py intent(in) bloks, integs, nbloks, ipivot
!f2py intent(out) detsgn
!f2py intent(out) detlog
...
!f2py intent(in) n
!f2py intent(in) kpm
!f2py intent(in) lenblk
!f2py intent(out) integs
!f2py intent(out) bloks
!f2py intent(out) work1
!f2py intent(out) work2
!f2py intent(out) nbloks
!f2py intent(out) b
...
!
  ...
  integer ( kind = 4 ) i
!f2py intent(in) break, coef, l, k, lnew
!f2py intent(out) brknew, coefg
...
!f2py intent(in) nrow, ncol, last
!f2py intent(out) ipivot
!f2py intent(inout) d, w, iflag
!
...
!
  ...
  integer ( kind = 4 ) nrow
  real ( kind = 8 ) scrtch(*)
!f2py intent(in) integs, nbloks
!f2py intent(out) ipivot, iflag
!f2py intent(inout) bloks, scrtch
...
!
  ...
  real ( kind = 8 ) totalw
  real ( kind = 8 ) weight
!f2py intent(in) t, n, k
!f2py intent(inout) diag
!f2py intent(out) q, bcoef
...
!
  ...
  real ( kind = 8 ) totalw
  real ( kind = 8 ) weight
!f2py intent(in) iprfun
!f2py intent(out) ftau, error
...
!
  ...
  real ( kind = 8 ) value
  real ( kind = 8 ) x
!f2py intent(in) break, coef, l, k, x, jderiv
!f2py intent(out) ppvalu
...
!
  ...
  real ( kind = 8 ) xside
  real ( kind = 8 ) xx
!f2py intent(in) t, kpm, left, nrow
!f2py intent(inout) scrtch, dbiatx
!f2py intent(out) q, b
...
!
  ...
  real ( kind = 8 ) size
  real ( kind = 8 ) x
!f2py intent(in) x, size
!f2py intent(out) round
...
!
  ...
  integer ( kind = 4 ) nrow
  real ( kind = 8 ) x(*)
!f2py intent(in) bloks, integs, nbloks, ipivot, b
!f2py intent(out) x
!
!  Forward substitution:
!
...
!f2py intent(in) x, dx, y, npoint
!f2py intent(out) v, qty
...
!
  ...
  integer ( kind = 4 ) last
  integer ( kind = 4 ) m
!f2py intent(in) ai, ipivot, nrowi, ncoli, last, nrowi1, ncoli1
!f2py intent(inout) ai1
...
!
  ...
  integer ( kind = 4 ) ipivot(*)
  real ( kind = 8 ) x(*)
!f2py intent(in) integs, nbloks, b
!f2py depend(nbloks) integs
!f2py intent(out) ipivot, x, iflag
!f2py intent(inout) bloks
!
...
!
  ...
  real ( kind = 8 ) x(npoint)
  real ( kind = 8 ) y(npoint)
!f2py intent(in) x, y, dy, npoint, s
!f2py intent(inout) v, a
...
!
  ...
  real ( kind = 8 ) taui
  real ( kind = 8 ) work(n)
!f2py intent(in) tau, gtau, t, n, k, m
!f2py intent(inout) work
!f2py intent(out) q, bcoef, iflag
...
!
  ...
  real ( kind = 8 ) sum1
  real ( kind = 8 ) tol
! warning: f2py warns invalid syntax for tolrte
!  real ( kind = 8 ), parameter :: tolrte = 0.000001D+00
  real ( kind = 8 ) tolrte
  real ( kind = 8 ) xij
!f2py intent(in) tau, n, k
!f2py depend(n) tau
!f2py depend(n,k) t
!f2py intent(out) t, iflag, scrtch

! set tolrte explictly here, see above please
  tolrte = 0.000001D+00
  nmk = n - k
...
!
  ...
  real ( kind = 8 ) w(nrow,ncol)
  real ( kind = 8 ) x(ncol)
!f2py intent(in) w, ipivot, nrow, ncol, last
!f2py intent(inout) x
...
!
  ...
  real ( kind = 8 ) x(nrow)
!f2py intent(in) w, ipivot, nrow, last
!f2py intent(out) b, x
...
!
  ...
  real ( kind = 8 ) zeta
  real ( kind = 8 ) zt2
!f2py intent(in) tau, gtau, ntau, gamma
!f2py intent(out) break, coef, l, k, iflag, s
