...
gfortran -o %libname%_test.exe %libname%_test.f90 lib%libname%.a
%libname%_test.exe > %libname%_test_output.txt
echo " --- TEST LIB ---"
echo "diff between ref. and current %libname%_prb_output.txt"
fc %libname%_test_output_ref.txt %libname%_test_output.txt
