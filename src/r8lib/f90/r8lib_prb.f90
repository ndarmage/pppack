...
subroutine r8_pythag_test ( )

!*****************************************************************************80
!
!! R8_PYTHAG_TEST tests R8_PYTHAG.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'R8_PYTHAG_TEST'
  write ( *, '(a)' ) '  R8_PYTHAG computes sqrt(A^2+B^2), avoiding'
  write ( *, '(a)' ) '  underflow or overflow where possible.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '         A         B          R8_PYTHAG(A,B)'
  write ( *, '(a)' ) ' '
  ...
  do i = 1, 7
    ...
    value = r8_pythag ( a, b )
    write ( *, '(2x,g14.6,2x,g14.6,2x,g14.6)' ) a, b, value
    b = b / 2.0D+00
  ...
  do i = 1, 7
    ...
    value = r8_pythag ( a, b )
    write ( *, '(2x,g14.6,2x,g14.6,2x,g24.16)' ) a, b, value
    b = b / 2.0D+00
